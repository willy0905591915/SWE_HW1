...
class PollsViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.choice1 = Choice.objects.create(question=self.question, choice_text="Option 1", votes=0)
        self.choice2 = Choice.objects.create(question=self.question, choice_text="Option 2", votes=0)
